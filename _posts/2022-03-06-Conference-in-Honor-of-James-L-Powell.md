 ...
 **Reception hosted by Dan and Bev McFadden, 6:30 to 9:30PM**    
...
| 9:00 to 9:30 AM | Alex Poirier (remote) | Identification and Estimation of Average Partial Effects in a Semiparametric Binary Response Panel Model |
| 9:30 to 10:00 AM | Ariel Pakes | Unobserved Heterogeneity, State Dependence, and Health Plan Choices |
| 10:00 to 10:30 AM | Whitney Newey | Panel Estimation of Tax Effects with Endogenous Budget Sets |
| 10:30 to 10:45 AM | | Coffee Break |
|  |  | **Session 2: Instrumental Variables** |       
| 10:45 to 11:15 AM | Marcelo Moreira | Efficiency Loss of Asymptotically Efficient Tests in an Instrumental Variables Regression |
| 11:15 to 11:45 AM | Andrew Chesher | IV Methods for Tobit Models | 
| 11:45 AM to 12:15 PM | Jerry Hausman (remote) | Problems with the Control Variable Approach in Achieving Unbiased Estimates in Nonlinear Models in the Presence of Many Instruments | 
| 12:15  to 1:45PM | | Lunch |
{:.mbtablestyle}                            



**Afternoon Session: 1:45 PM to 4:30 PM**    
...
| 3:00 to 3:30 PM | Songnian Chen (remote) | Quantile Regression with Group-Level Treatments |
| 3:30 to 4:00 PM | Carolina Caetano | Partial Identification of Treatment Effects Using Bunching |
| 4:00 to 4:30 PM | Guido Imbens | Fixed Effects and the Propensity Score |
| 4:30 PM  | | Adjorn |
{:.mbtablestyle}
...
**Conference Dinner (by invitation only): 7PM @ [Agrodolce Berkeley](https://www.agrodolceberkeley.com/)** 
...
| 9:00 to 9:30 AM | Sergio Firpo | Uniform Inference for Value Functions |
| 9:30 to 10:00 AM | Konrad Menzel | Structural Sieves |
| 10:00 to 10:30 AM | Lars Hansen (remote) | Risk, Ambiguity and Misspecification: Implications for Policy |
| 10:30 to 10:45 AM | | Coffee Break |
|  |  | **Session 6: High-Dimensional Models** |
| 10:45 to 11:15 AM | Andres Aradillas-Lopez | Inference with Partially Identified Control Variables |
| 11:15 to 11:45 AM | Cheng Hsiao | Statistical Inference for Low Dimensional Parameters in the Presence of High Dimensional Covariates |
| 11:45 AM to 12:15 PM | Joel Horowitz | Bootstrap Based Asymptotic Refinements for High-Dimensional Nonlinear Models |
...
| 1:15 to 1:45 PM | Max Kasy | Rationalizing Pre-Analysis Plans: Statistical Decisions Subject to Implementability |
| 1:45 to 2:15 PM | James Heckman (remote) | Orthogonal Designs for Causal Inference in Social Experiments (tentative) |
| 2:15 to 2:30 PM | | Coffee Break |
|  |  | **Session 8: Networks** |
| 2:30 to 3:00 PM | Eric Auerbach | Spectral Regression for Networks, Panels, and Outcome Matrices |
| 3:00 to 3:30 PM | Fengshi Niu | Error Components Models for Dyadic Data |
| 3:30 PM  | | Adjorn |
{:.mbtablestyle}         
