...
### Articles
`2024` “Measuring the effects of segregation in the presence of social spillovers: a nonparametric approach,” accepted by the _Journal of Econometrics_ (with Guido Imbens and Geert Ridder). 

“Sparse network asymptotics for logistic regression under possible misspecification,” forthcoming at _Econometrica_.    
...
`2020` “An optimal test for strategic interaction in social and economic network formation between heterogeneous agents,” second revision resubmitted to the _Review of Economic Studies_ (with Andrin Pelican).    
...
## Teaching
`Undergraduate` Econometrics, Applied Econometrics, Advanced Econometrics         
