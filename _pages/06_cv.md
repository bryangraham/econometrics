...
### Articles
`2020` “Network data,” _Handbook of Econometrics_ 7A (S. Durlauf, L. Hansen, J. Heckman & R. Matzkin, Eds.) Amsterdam: North-Holland, 2020.   

"Introduction," in _The Econometric Analysis of Network Data_ (Bryan Graham & Aureo de Paula, Eds.). Amsterdam: Academic Press, 2020 (with Aureo de Paula).    

"Dyadic regression," in _The Econometric Analysis of Network Data_ (Bryan Graham & Aureo de Paula, Eds.). Amsterdam: Academic Press, 2020.    

"Testing for externalities in network formation using simulation," in _The Econometric Analysis of Network Data_ (Bryan Graham & Aureo de Paula, Eds.) Amsterdam: Academic Press, 2020 (with Andrin Pelican).    
...
“An optimal test for strategic interaction in social and economic network formation between heterogeneous agents,” (with Andrin Pelican), 2019.    
 
“Raising student achievement through improved teacher classroom assignment policies“ (with Geert Ridder, Petra Thiemann and Gema Zamarro), 2019.
