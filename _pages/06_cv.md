...
`2025` Elected Fellow of the Econometric Society (ES)          
`2023` Elected Fellow of the Interational Association of Applied Econometrics (IAAE)         
...
### Articles
`2024` “An optimal test for strategic interaction in network formation games,” conditionally accepted the _Review of Economic Studies_ (with Andrin Pelican).        

“Measuring the effects of segregation in the presence of social spillovers: a nonparametric approach,”  _Journal of Econometrics_ 252 (B): 106006 (with Guido Imbens and Geert Ridder). 

“Sparse network asymptotics for logistic regression under possible misspecification,” _Econometrica_ 92 (6): 1837 - 1868.    

“Kernel density estimation for undirected dyadic data,” _Journal of Econometrics_ 240 (2): Article 105336 (with Fengshi Niu and James L. Powell).      
...
"ET Interview: Professor Gary Chamberlain," _Econometric Theory_ 39: 1 - 26 (with Keisuke Hirano and Guido W. Imbens).    
  
`2022` “Introduction to the Annals Issue in Honor of Gary Chamberlain,”  _Journal of Econometrics_ 226 (1): 1 - 3 (with Keisuke Hirano).         
...
`2025` “Moment restrictions for nonlinear panel data models with feedback,” (with Stephane Bonhomme and Kevin Dano).   
...
`2026` American Economics Association "Recent Developments in Working with Network Data", ASSA Meetings, Philadelphia   
Journal of Business and Economic Statistics (JBES) Lecture, ASSA Meetings, Philadelphia  
...
## Teaching
`Undergraduate` Econometrics, Applied Econometrics, Advanced Applied Econometrics         
`Graduate` 1st & 2nd year Econometrics, Applied Econometrics  

## Short courses
`2026` “Econometric Methods for Social Spillovers and Networks,” University of St. Gallen, Switzerland       
...
### On campus
`Department` (Past and on-going) Undergraduate, graduate, personnel committees. Equity advisor. Faculty Advisor to Business & Industrial Analytics domain emphasis of Data Science major.    
`Campus-wide` (Past and on-going) Faculty advisory committee for UC Martial Arts Program. Faculty Athletics Council (FACL, Chair), Student-Athlete Admissions Committee (SAAC), Committee on Courses & Instruction (COCI), Undergraduate Council (UGC), Faculty Fellow - Cal Womens and Mens Cross Country Team   
 

### Editorial positions
`2026 - ` Co-Editor, _Econometric Theory_
...
### Conferences
`2025` Organizer, CAMSE/CLIMB Mini-Conference, UC - Berkeley    
`2024` Organizer, CAMSE/CLIMB Mini-Conference, UC - Berkeley    
...
`2020` Program committee, World Congress of the Econometric    Society  
