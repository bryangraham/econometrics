...
`2020` “Sparse network asymptotics for logistic regression,” revision requested by _Econometrica_.        

“An optimal test for strategic interaction in social and economic network formation between heterogeneous agents,” resubmitted to the _Review of Economic Studies_ (with Andrin Pelican).    

“Teacher-to-classroom assignment and student achievement,” revision requested by the _Journal of Business and Economic Statistics_ (with Geert Ridder, Petra Thiemann and Gema Zamarro).
