...
“Network data,” _Handbook of Econometrics_ 7A (S. Durlauf, L. Hansen, J. Heckman & R. Matzkin, Eds.) Amsterdam: North-Holland.   

"Introduction," in _The Econometric Analysis of Network Data_ (B. Graham & A. de Paula, Eds.). Amsterdam: Academic Press (with Aureo de Paula).    

"Dyadic regression," in _The Econometric Analysis of Network Data_ (B. Graham & A. de Paula, Eds.). Amsterdam: Academic Press.    

"Testing for externalities in network formation using simulation," in _The Econometric Analysis of Network Data_ (B. Graham & A. de Paula, Eds.) Amsterdam: Academic Press (with Andrin Pelican).    
